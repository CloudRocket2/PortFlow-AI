    ...
    <div className="flex flex-col h-full w-full animate-page-enter">
      ...
      <div className="flex items-start justify-between mb-2">
        <div className="flex flex-col">
          ...
          <div className="text-[10px] font-mono text-neutral-500 uppercase tracking-widest mt-1 transition-all duration-200 tabular-nums">
      ...
      <div className="flex flex-col gap-2 mt-auto border-t border-neutral-800 pt-3">
        <div className="text-[10px] font-mono text-neutral-500 uppercase tracking-widest mb-1 transition-all duration-200">Primary Drivers</div>
        ...
        <div className="flex items-center justify-between hover:bg-white/[0.02] p-1 -mx-1 rounded transition-colors duration-200">
          ...
          <span className="text-xs font-mono text-red-400 font-bold tabular-nums">+8.2% (2w)</span>
        </div>
        ...
        <div className="flex items-center justify-between hover:bg-white/[0.02] p-1 -mx-1 rounded transition-colors duration-200">
          ...
          <span className="text-xs font-mono text-red-400 font-bold tabular-nums">+5.1% (30d)</span>
        </div>
      </div>
    </div>
  );
