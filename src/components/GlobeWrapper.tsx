      ...
      {selectedVoyageId && selectedRouteInfo && selectedShipInfo && (
        <div className="absolute top-4 left-4 z-20 w-72 bg-black/90 border border-[#00ff00]/40 p-4 shadow-2xl backdrop-blur-md">
          <div className="flex justify-between items-start mb-3 border-b border-neutral-800 pb-2">
            ...
            <button onClick={() => setSelectedVoyageId(null)} className="text-neutral-500 hover:text-white">
              <X className="w-4 h-4" />
            </button>
          </div>
          ...
          <div className="space-y-2 text-sm font-mono">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-white text-right">{selectedShipInfo.cargo}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-neutral-500">ETA</span>
              <span className="text-[#00ff00] text-right font-bold">{selectedShipInfo.eta}</span>
            </div>
          </div>
        </div>
      )}
